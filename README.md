...
[![Python Lint and Test](https://github.com/michaeldavie/env_canada/actions/workflows/python-app.yml/badge.svg)](https://github.com/michaeldavie/env_canada/actions/workflows/python-app.yml)
...
> **Note**: Legends are rendered by the library itself, in the style of Environment Canada's weather map, rather than fetched from the WMS server. A change to the server's styles therefore needs a matching update to `ec_legend.py`.
